...
export default function AskOphelia() {
  ...
  return (
    <div
      className="relative flex h-[calc(100vh-73.6px)] w-full flex-col
                    bg-gradient-to-b from-[#0E1D21] via-black to-black">
      {/* Header */}
      <header className="w-full pt-10 text-center">
        <h1 className="text-5xl font-extrabold tracking-wide text-[#C2B280] ml-6 my-4 text-center w-full">
          Ophelia
        </h1>
      ...
      {/* Chat panel */}
      <div
        className="mx-auto mt-4 w-full max-w-5xl flex-1 overflow-y-auto px-3 sm:px-6 py-6
        ...
        <div className="flex flex-col gap-4">
                ...
                {!isUser && (
                  <div
                    className="grid h-8 w-8 place-items-center rounded-full
                                  bg-[#C2B280]/20 text-[#C2B280] font-bold">
                    O
                  </div>
                )}
                <div
          ...
          {isLoading && (
            <div className="flex items-start gap-3">
              ...
              <div
                className="rounded-2xl rounded-bl-none bg-[#0E1D21]/90 px-5 py-3
